...
2. If code is available, start with a code-first review using `references/swiftui-performance-audit/code-smells.md`.
...
4. If code review is inconclusive or runtime evidence is required, guide the user through profiling with `references/swiftui-performance-audit/profiling-intake.md`.
5. Summarize likely causes, evidence, remediation, and validation steps using `references/swiftui-performance-audit/report-template.md`.
...
For the full profiling intake checklist, read `references/swiftui-performance-audit/profiling-intake.md`.
...
Use `references/swiftui-performance-audit/code-smells.md` for the detailed smell catalog and fix guidance.
...
Use `references/swiftui-performance-audit/profiling-intake.md` for the exact checklist and collection steps.
...
Use `references/swiftui-performance-audit/code-smells.md` for examples, Observation-specific fan-out guidance, and remediation patterns.
...
Use `references/swiftui-performance-audit/report-template.md` when formatting the final audit.

## References

- Profiling intake and collection checklist: `references/swiftui-performance-audit/profiling-intake.md`
- Common code smells and remediation patterns: `references/swiftui-performance-audit/code-smells.md`
- Audit output template: `references/swiftui-performance-audit/report-template.md`
- Add Apple documentation and WWDC resources under `references/` as they are supplied by the user.
- Optimizing SwiftUI performance with Instruments: `references/swiftui-performance-audit/optimizing-swiftui-performance-instruments.md`
- Understanding and improving SwiftUI performance: `references/swiftui-performance-audit/understanding-improving-swiftui-performance.md`
- Understanding hangs in your app: `references/swiftui-performance-audit/understanding-hangs-in-your-app.md`
- Demystify SwiftUI performance (WWDC23): `references/swiftui-performance-audit/demystify-swiftui-performance-wwdc23.md`
