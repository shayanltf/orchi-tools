...
- Choose the relevant reference from `references/swiftui-patterns/components-index.md`.
...
- For a new app scaffold, also create one project-local `script/build_and_run.sh` and `.codex/environments/environment.toml` so the Codex app Run button works immediately. Use the exact bootstrap contract from `../build/references/build-run-debug.md` and its `../build/references/build-run-debug/run-button-bootstrap.md` file rather than inventing a second variant here.
...
`references/swiftui-patterns/split-inspectors.md`.
...
- `references/swiftui-patterns/components-index.md`: entry point for scene and component guidance.
- `references/swiftui-patterns/windowing.md`: choosing between `WindowGroup`, `Window`, `DocumentGroup`, and window-opening patterns.
- `references/swiftui-patterns/settings.md`: dedicated settings scenes, `SettingsLink`, and preference layouts.
- `references/swiftui-patterns/commands-menus.md`: command menus, keyboard shortcuts, focused values, and desktop action routing.
- `references/swiftui-patterns/split-inspectors.md`: sidebars, split views, selection-driven layout, and inspectors.
- `references/swiftui-patterns/menu-bar-extra.md`: menu bar extra structure and when it fits.
...
Use `references/swiftui-patterns/components-index.md` as the entry point. Each component reference should include:
