...
- `references/ios-app-intents/first-pass-checklist.md` for choosing the first intent and entity surface
- `references/ios-app-intents/example-patterns.md` for concrete example shapes to copy and adapt
- `references/ios-app-intents/code-templates.md` for generalized App Intents code templates
- `references/ios-app-intents/system-surfaces.md` for how to think about Shortcuts, Siri, Spotlight, widgets, and other system entry points
