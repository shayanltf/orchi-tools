...
- `references/appkit-interop/representables.md`: choosing between view and view-controller wrappers, plus coordinator patterns.
- `references/appkit-interop/window-panels.md`: window access, utility windows, and open/save panels.
- `references/appkit-interop/responder-menus.md`: first responder, command routing, and menu validation.
- `references/appkit-interop/drag-drop-pasteboard.md`: pasteboard, file URLs, and desktop drag/drop edges.
